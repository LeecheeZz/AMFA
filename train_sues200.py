...
class Configuration:
 ...
 # ---------------------------------------------------------------------------------------------------------------
        ...
        parser.add_argument('--ckpt_path',
                            default='checkpoints/sues-200/convnext_base.fb_in22k_ft_in1k_384/0220_23:01:14/weights_e1_0.8965.pth',
        ...
        parser.add_argument('--altitude', default=150, type=int, help="150|200|250|300")

        parser.add_argument('--data_folder', default=r'../../dataset/', type=str)
        parser.add_argument('--dataset_name', default='/SUES-200-512x512/Dataset/', type=str)

        # Our tricks
        parser.add_argument('--weight_infonce', default=1.0, type=float)
        parser.add_argument('--weight_cls', default=0.1, type=float)
        parser.add_argument('--weight_tri', default=0.0, type=float)
        ...
        # parser.add_argument('--gpu_ids', default="2", type=tuple)
...
if __name__ == '__main__':
    ...
    if config.only_test:
        ...
        if 1:
            del checkpoint['model_1.classifier.classifier.0.weight']
            del checkpoint['model_1.classifier.classifier.0.bias']
    ...
    for epoch in range(1, config.epochs + 1):
        ...
        # else:
        #     torch.save(model.state_dict(), '{}/weights_e{}_{}.pth'.format(model_path, epoch, time.strftime("%m%d%H%M%S")))
