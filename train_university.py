...
#---------------------------------------------------------------------------------------------
        ...
        # model config ablation ->  
        parser.add_argument('--only_test', default=False, type=bool, help='use pretrained model to test')
        parser.add_argument('--ckpt_path',
                            default='checkpoints/university/convnext_base.fb_in22k_ft_in1k_384/02/08_23:41:14/weights_e1_0.9356.pth',
        ...
        # parser.add_argument('--gpu_ids', default=(1,), type=tuple)
...
if __name__ == '__main__':
    ...
    with open('%s/opts.yaml'%(config.model_path),'a') as fp:
        yaml.dump(vars(config), fp, default_flow_style=False)
    ...
    loss_fn5 = DKD(alpha=0.4, beta=1.6, temperature=4)
